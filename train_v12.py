#!/usr/bin/env python3
"""
v12 training: Same as v11 but with local_loss_weight=0.5 (was 0.0).

Key change from v11:
  - local_loss_weight=0.5: now training on ALL 8 codebooks instead of
    just codebook-0. This means DPO can learn preferences about fine
    acoustic detail (timbre, texture) not just coarse structure.
  - Everything else identical to v11 for fair comparison.
"""
...
logger = logging.getLogger("train_v12")
...
trainer = DPOTrainer(
    ...
    checkpoint_dir="/workspace/dpo_checkpoints_v12",
...
logger.info("Checkpoints: /workspace/dpo_checkpoints_v12")
